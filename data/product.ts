...
intro:"Une rencontre subtile entre bergamote et vétiver.",
theme: {
    top: "Bergamote",
    heart: "Freesia",
    base: "Vetivier"
...
description:[
"La bergamote apporte une fraîcheur vive et lumineuse.",
"Le vétiver révèle une profondeur boisée apaisante."
],
images:[
"/images/products/harmonie(1).webp",
"/images/products/harmonie(2).webp",
"/images/products/harmonie(3).webp",
...
name:"Ancrage",
slug:"bougie-ancrage",
intro:"Une bougie conçue pour soutenir l'ancrage et la stabilité intérieure.",
theme: {
    top: "Encens",
    heart: "Cèdre",
    base: "Bois de sental & musc"
  },
createdAt:new Date(),
stock:true,
promo:0,
...
intro:"Une invitation à ralentir et écouter son intuition.",
theme: {
    top: "Citron",
    heart: "Magnolia",
    base: "Cèdre & musc"
